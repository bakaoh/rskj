...
public class LightProcessor {
    ...
    public LightProcessor(@Nonnull final Blockchain blockchain, final BlockSyncService blockSyncService) {
    ...
    public void processBlockReceiptsRequest(MessageChannel sender, long requestId, byte[] blockHash) {
        logger.trace("Processing block receipts request {} block {} from {}", requestId, Hex.toHexString(blockHash));
    ...
    /**
     * processBlockReceiptsResponse ....
     *
     * @param sender the sender of the BlockReceipts message.
     * @param requestId the id of the request
     * @param blockReceipts   the requested block hash.
     */
